...
const PILLARS = [
  ...
  { id: "graphic-design", n: "05", title: "Graphic Design", tagline: "Look like you mean business.", body: "Every asset we produce is built to support how you communicate, sell, and operate. Deliverables are provided as print-ready and web-ready files. Editable source files are included only where agreed as part of the service scope.", deliverables: ["Sales and pitch decks", "Social and content templates", "Custom Canva template systems — available on request and scoped separately", "Document and proposal templates", "Brand consistency guidelines"] },
];
